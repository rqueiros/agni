<template>
  <v-navigation-drawer app width="15%" permanent style="height: 100%; background-color: lightgray;">
    <v-sheet
      class="pa-4 menu_links" style="background-color: lightgray;"
    ...
    <v-list nav minimum-height="10">
      <v-divider></v-divider>
      <v-list-item
        class="menu_list-item menu_links"
        title="Main"
        value="main"
