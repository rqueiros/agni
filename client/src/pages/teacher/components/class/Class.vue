  ...
  <v-container class="pa-0">
    ...
    <v-row no-gutters>
      <template v-for="occ in currentOcc">
        <v-col :key="occ.id">
          <v-card width="100%" outlined style="border-color: #C3C3C3;" class="pa-4 text-center text-h5"
      ...
      <v-col cols="6" class="mt-4 pr-2">
        <v-card width="100%" outlined style="border-color: #C3C3C3;" class="pt-3">
          <v-card-title class="py-0 text-body-1 mb-1">
            ...
            <v-text-field style="width:1%" v-model="draftSearch" prepend-inner-icon="mdi-magnify" label="Search" single-line
              class="pa-0 ma-0 ml-6 mr-12 mb-1 text-field" outlined dense hide-details></v-text-field>
          </v-card-title>
          <v-data-table :itemsPerPage="itemsPerPage" dense :headers="draftHeader" :items="draftOcc" :search="draftSearch"
      ...
      <v-col cols="6" class="mt-4 pl-2">
        <v-card width="100%" outlined style="border-color: #C3C3C3;" class="pt-3">
          <v-card-title class="py-0 text-body-1 mb-1">
            ...
            <v-text-field style="width:1%" v-model="pastSearch" prepend-inner-icon="mdi-magnify" label="Search" single-line
              class="pa-0 ma-0 ml-6 mr-12 mb-1 text-field" outlined dense hide-details></v-text-field>
          </v-card-title>
          <v-data-table :itemsPerPage="itemsPerPage" dense :headers="pastHeader" :items="pastOcc" :search="pastSearch" @click:row="openCollectionType"
            :loading="loading">
          </v-data-table>
        </v-card>
      </v-col>
...
#forSearch>>>.v-text-field.v-text-field--enclosed:not(.v-text-field--rounded) > .v-input__control > .v-input__slot, .v-text-field.v-text-field--enclosed .v-text-field__details{
