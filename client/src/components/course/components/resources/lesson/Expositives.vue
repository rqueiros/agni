...
export default {
  ...
  data() {
    return {
      ...
      tab: null,
      dialog: false,
      addExpositiveMenu: [{ title: "NEW" }, { title: "SELECT" }]
    };
  },
...
#expositives >>> .v-toolbar__content,
.v-toolbar__extension {
  padding: 0;
}
#expositives >>> .v-toolbar__content > .v-tabs:first-child,
.v-toolbar__extension > .v-tabs:first-child {
  margin: 0;
}
#expositives >>> .v-slide-group__next,
.v-slide-group__prev {
  min-width: 24px;
}
</style>
